    ...
    <div class="container">        
        ...
        <div class="navbar-collapse">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link btn btn-white btn-round" href="sign-in.jsp">SIGN IN</a>
                </li>
            </ul>
        </div>
    </div>
            ...
            <div class="card-plain">
                <form class="form" method="post" action="LoginServlet">
                    ...
                    <div class="content">                                                
                        ...
                        <div class="input-group">
                            <input type="password" placeholder="Confirm Password" id="re_password" class="form-control" required/>
                            <span class="input-group-addon">
                                <i class="zmdi zmdi-lock"></i>
                            </span>
                        </div>                        
                    ...
                    <button id="submit" name="action" value="register" disabled class="btn btn-primary btn-round btn-lg btn-block waves-effect waves-light">SIGN UP</button>
    ...
    <footer class="footer">
        <div class="container">
            ...
            <div class="copyright">
                ...
                <span>Designed by <a href="https://ishaan.pythonanywhere.com/" target="_blank">ITS Student Hub</a></span>
            </div>
        </div>
    </footer>
</div>
