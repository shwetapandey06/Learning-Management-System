	    ...
	    <div class="container-fluid">
	        <div class="row clearfix">
	            <div class="col-md-6 col-lg-4">
		                <div class="card">
		                    <div class="body">
		                        <img src="assets/images/exams/${exam.image}" alt=""  class="img-fluid rounded m-b-20">
		                        <h6>${exam.name}</h6>
		                            ...
		                            <table class="table table-hover m-t-20">
		                                <tbody>
		                                    ...
		                                    <tr>
		                                        ...
		                                        <td><strong class="col-blush">${exam.date }</strong></td>
		                                    </tr>
		                                </tbody>
		                            </table>
		                        </div>
		                        <!-- <a href="courses-info.html" class="btn btn-block btn-raised btn-default btn-simple btn-round waves-effect" role="button">Apply Now</a> -->
		                    </div>
		                </div>
		                ...
		                <div class="card">
		                    <div class="body">
		                    	<h4>Professor</h4>
		                        <img src="assets/images/professors/${prof.image}" alt=""  class="img-fluid rounded m-b-20">
		                        <h6>${prof.position }&nbsp;${prof.fname }&nbsp;${prof.lname }</h6>
		                        <div class="table-responsive">
		                            <table class="table table-hover m-t-20">
		                                <tbody>
		                                    <tr>
		                                        <td>Professor Id</td>
		                                        <td class="col-blush">${prof.id }</td>
		                                    </tr>
		                                    <tr>
		                                        <td>Department</td>
		                                        <td><strong class="col-blush">${prof.department }</strong></td>
		                                    </tr>
		                                    <tr>
		                                        <td>Email</td>
		                                        <td><strong class="col-blush">${prof.email }</strong></td>
		                                    </tr>
		                                    <tr>
		                                        <td>Phone</td>
		                                        <td><strong class="col-blush">${prof.phone }</strong></td>
		                                    </tr>
		                                </tbody>
		                            </table>
		                        </div>
	                                    ...
	                                    <table class="table table-bordered">
	                                        ...
	                                        <tbody>
	                                            <tr>
	                                                ...
	                                                <td>
	                                                	<c:choose>
	                                                		<c:when test="${exam.bca }">YES</c:when>
	                                            ...
	                                            <tr>
	                                                ...
	                                                <td>
	                                                	<c:choose>
	                                                		<c:when test="${exam.mca }">YES</c:when>
	                                                	    <c:otherwise>NO</c:otherwise>
														</c:choose>
													</td>
	                                            </tr>
	                                            <tr>
	                                                ...
	                                                <td>
	                                                	<c:choose>
	                                                		<c:when test="${exam.bba }">YES</c:when>
	                                                	    <c:otherwise>NO</c:otherwise>
														</c:choose>
													</td>
	                                            </tr>
	                                            <tr>
	                                                ...
	                                                <td>
	                                                	<c:choose>
	                                                		<c:when test="${exam.mba }">YES</c:when>
	                                                	    <c:otherwise>NO</c:otherwise>
														</c:choose>
													</td>
	                                            </tr>
	                                            <tr>
	                                                ...
	                                                <td>
	                                                	<c:choose>
	                                                		<c:when test="${exam.pgdm }">YES</c:when>
	                                                	    <c:otherwise>NO</c:otherwise>
														</c:choose>
													</td>
	                                            </tr>
